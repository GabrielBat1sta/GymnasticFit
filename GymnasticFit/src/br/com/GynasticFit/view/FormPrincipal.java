...
public class FormPrincipal extends JFrame {
	...
	private JPanel panelCad,panelConsul,panelPag,panelAAcess,panelRel,panelProd,panelProv;
	private JPanel panelConsul_1;
	...
	public FormPrincipal() {
		...
		btnPagamento.setBounds(7, 202, 187, 37);
		...
		panelConsul_1 = new JPanel();
		panelConsul_1.setVisible(false);
		panelConsul_1.setBackground(new Color(204, 153, 0));
		panelConsul_1.setBounds(199, 153, 7, 37);
		panelLateral.add(panelConsul_1);
