...
public class FormPrincipal extends JFrame {
	...
	private JButton btnAutoAcesso;
	private JButton btnFuncionario;
	private JButton btnProdutos;
	private JButton btnProvedor;
	...
	public void esconderBotoes() {
		...
		btnAutoAcesso.setBounds(7, 272,58, 37);
		btnAutoAcesso.setText("");
		
		btnFuncionario.setBounds(7, 315,58, 37);
		btnFuncionario.setText("");
		
		btnProdutos.setBounds(7, 359,58, 37);
		btnProdutos.setText("");
		
		btnProvedor.setBounds(7, 405,58, 37);
		btnProvedor.setText("");
	...
	public void mostrarBotoes() {
		...
		btnAutoAcesso.setBounds(7, 279, 187,37);
		btnAutoAcesso.setText("   Autorizar Acesso     ");
		
		if(btnAutoAcesso.getBounds().width == 203) {
			btnAutoAcesso.setBackground(Color.white);
		}
		
		btnFuncionario.setBounds(7, 327, 187,37);
		...
		btnProdutos.setBounds(7, 375, 187,37);
		...
		btnProvedor.setBounds(7, 423, 187,37);
		btnProvedor.setText("           Provedor         ");
		
		if(btnProvedor.getBounds().width == 203) {
	...
	public FormPrincipal() {
		...
		btnAutoAcesso = new JButton("   Autorizar Acesso     ");
		btnAutoAcesso.setBackground(new Color(255, 255, 255));
		btnAutoAcesso.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		...
		btnProvedor = new JButton("           Provedor         ");
		btnProvedor.setBackground(new Color(255, 255, 255));
